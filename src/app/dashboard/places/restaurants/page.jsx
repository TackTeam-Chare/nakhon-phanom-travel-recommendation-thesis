...
import { fetchDistricts, fetchRestaurantsByDistrict } from "@/services/admin/dashboard/general/routes"
    ...
    <div className="container mx-auto p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {paginatedRestaurants.map(restaurant => (
          <Link href={`/dashboard/place/${restaurant.id}`} key={restaurant.id}>
            <div className="bg-white rounded-lg shadow-lg overflow-hidden transform hover:scale-95 transition duration-300 ease-in-out flex flex-col h-full">
              ...
              <div className="p-4 flex-grow flex flex-col">
                ...
                <Link
                  href={`/dashboard/place/${restaurant.id}`}
